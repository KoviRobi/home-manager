    ...
    options = {
      ...
      keybindings = mkOption {
        ...
        default = mapAttrs (n: mkOptionDefault) {
          ...
          "${cfg.config.modifier}+1" = { priority = 101; value = "workspace number 1"; };
          "${cfg.config.modifier}+2" = { priority = 102; value = "workspace number 2"; };
          "${cfg.config.modifier}+3" = { priority = 103; value = "workspace number 3"; };
          "${cfg.config.modifier}+4" = { priority = 104; value = "workspace number 4"; };
          "${cfg.config.modifier}+5" = { priority = 105; value = "workspace number 5"; };
          "${cfg.config.modifier}+6" = { priority = 106; value = "workspace number 6"; };
          "${cfg.config.modifier}+7" = { priority = 107; value = "workspace number 7"; };
          "${cfg.config.modifier}+8" = { priority = 108; value = "workspace number 8"; };
          "${cfg.config.modifier}+9" = { priority = 109; value = "workspace number 9"; };
          "${cfg.config.modifier}+0" = { priority = 110; value = "workspace number 10"; };

          "${cfg.config.modifier}+Shift+1" =
            { priority = 201; value = "move container to workspace number 1"; };
          "${cfg.config.modifier}+Shift+2" =
            { priority = 202; value = "move container to workspace number 2"; };
          "${cfg.config.modifier}+Shift+3" =
            { priority = 203; value = "move container to workspace number 3"; };
          "${cfg.config.modifier}+Shift+4" =
            { priority = 204; value = "move container to workspace number 4"; };
          "${cfg.config.modifier}+Shift+5" =
            { priority = 205; value = "move container to workspace number 5"; };
          "${cfg.config.modifier}+Shift+6" =
            { priority = 206; value = "move container to workspace number 6"; };
          "${cfg.config.modifier}+Shift+7" =
            { priority = 207; value = "move container to workspace number 7"; };
          "${cfg.config.modifier}+Shift+8" =
            { priority = 208; value = "move container to workspace number 8"; };
          "${cfg.config.modifier}+Shift+9" =
            { priority = 209; value = "move container to workspace number 9"; };
          "${cfg.config.modifier}+Shift+0" =
            { priority = 210; value = "move container to workspace number 10"; };
